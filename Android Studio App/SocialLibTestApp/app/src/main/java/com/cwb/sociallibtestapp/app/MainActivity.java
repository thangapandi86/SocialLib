...
import com.cwb.sociallib.lib.ActionItem;
import com.cwb.sociallib.lib.ImageLoader;
import com.cwb.sociallib.lib.QuickAction;
import com.cwb.sociallib.lib.SocialLogin;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Slogin = new SocialLogin(MainActivity.this, new ResponseListener());
    ...
    private final class ResponseListener implements DialogListener {
        ...
        public void onComplete(Bundle values) {
            ...
            LoaderDialog = new ProgressDialog(MainActivity.this);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                fragment = new FindPeopleFragment(contactsList,provider_name,MainActivity.this);
                break;
            case 2:
                fragment = new PhotosFragment(albumList,provider_name,MainActivity.this);
                break;
            case 3:
                fragment = new FeedFragment(feedList,provider_name,MainActivity.this);
                break;
            case 4:
                fragment = new PagesFragment(careerMap,provider_name,MainActivity.this);
                break;
            case 5:
