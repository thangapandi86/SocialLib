/****************************************************************/
	/* Career Fragment is to display user career datails, it using three  
    /* tab career, Recommentation, Education*/
/*****************************************************************/
...
public class CareerFragment extends Fragment implements OnClickListener{
	...
	public CareerFragment(Career careerMap2, String provider_name2,
			Context context) {
